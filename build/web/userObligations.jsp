	...
	<div class="container">
        ...
        <section id="content">     
            <div class="container">
                ...
                <s:query dataSource="${ds}" var="result1">
                    SELECT * FROM USER WHERE USERNAME = ?;
                    <s:param value="${sessionScope['loginUser']}" />
                </s:query>  
                    
                     <s:query dataSource="${ds}" var="result">
                    SELECT * FROM OBLIGATIONS WHERE USER_ID = ?;
                    <c:forEach items="${result1.rows}" var="row">
                        <s:param value="${row.ID}" />
                    </c:forEach>
                </s:query> 
                ...
                <form>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><c:out value="${row.OBL_INFO}"/></td>
                            <td><c:out value="${row.AMOUNT}"/></td>
                            <td><c:out value="${row.OBL_DATE}"/></td>
                        </tr>
                        </c:forEach>
                    </tbody>
