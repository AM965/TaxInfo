...
<head>
<meta charset="utf-8">
<title>TaxInfo - Create Obligation</title>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form  action="insertObligation.jsp"><font color="#656565">
                                    
                                    <div class="row">
                                                
                                        <div class="col-lg-1 ">
                                            <label for="obl_info">Obligation Name:</label>
                                        </div>
                                        <div class="col-lg-11 form-group">
                                            <input type="text" name="obl_info" placeholder="* Enter Obligation Type"/>
                                        </div>                                              
                                    </div>
                                    ...
                                    <input type="hidden" name="user_id" value="${param.company_id}"/>
                                    <br/>
                                    
                                   <div class="row">
                                        <div class="col-lg-12">
                                            <button class="btn btn-theme btn-medium margintop10 pull-left" type="submit">Create Obligation</button>
                                        </div>
